    ...
    <div className="absolute inset-0 bg-gradient-to-r from-white/10 to-white/0 
          ...
          >
            ...
            <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-10 text-justify">
              I build performant full-stack applications with clean code, modern design, and optimized user flows. 
              By uniting frontend elegance with backend strength, I deliver systems that are scalable, maintainable, 
